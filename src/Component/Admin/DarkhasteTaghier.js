            ...
            <div className=''>
                ...
                <div className='mx-5 my-5 d-flex justify-content-center'>
                    <p className='text-primary bg-secondary bg-opacity-10 p-2 px-3 w-100 text-center'>
                        شما از طریق این قسمت می توانید با درخواست تغییر مکان اقدام به ویرایش مکان آموزشگاه خود کنید 
                    </p>
                </div>
                {/* form */}
                <div className=' justify-content-center mx-3 bg-white p-3'>
                          ...
                          <Tab.Container className='bg-transparent' eventKey="home" title="تهران">
                              <div className=' d-flex border-bottom'>
                                  <div className='my-3 p-3 border rounded'>
                                      ...
                                      <p className='my-4'>احتراما به استحضار می رساند اینجانب ....... موسس آموزشگاه آزاد ...... درخواست آدرس در شهر تهران ، منطقه ....... در رشته های ....... دارم .</p>
                                  </div>
                              </div>
                          </Tab.Container>
                  ...
                  <div className='d-grid col-2 me-auto'>
                      ...
                      <button className='btn btn-primary my-2 rounded-0 '>  دانلود </button>
                      <button className='btn btn-primary my-2 rounded-0 '>  آپلود </button>
                  </div>
...
export default DarkhasteTaghier