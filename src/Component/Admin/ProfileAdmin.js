      ...
      <div className='container-fluid py-2 px-3 m-0 my-2 mb-4'>
              ...
              <div className=''>
                ...
                <div className='d-flex bg-warnin bg-opacity-25 align-items-center my-2 shadow shadow-sm border border-1 border-secondary ulpp'>
                  ...
                  <p className='my-0 d-flex'>
                    ...
                    <span className='d-grid col px-4 mx-1 my-1 py-1 rounded border border-2 bg-primary bg-opacity-75'>هردو</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className='my-3'>
          <div className='border border-2 p-2'>
            <fieldset className=''>
              <legend className='bg-primary bg-opacity-50 fw-bold p-2'> رشته های فعالیت آموزشگاه </legend>
