        ...
        <div className='justify-content-center my-3'>
            <div className='d-flex justify-content-around mt-4 TabVeiw1'>
                <div className='d-flex flex-column align-items-center TabVeiw12'>
                    ...
                    <span className={`my-3 px-4 text-center ${level === 0 ? "active-1" : "deavtive-1"}`}> ثبت نام اولیه </span>
                </div>
                <div className='d-flex flex-column align-items-center'>
                    ...
                    <span className={`mx-5 mt-3 d-flex p-2 rounded-circle btn-outline-light ${level === 1 ? "active22" : "deactive22"}`}></span>
                    <span className={`my-3 px-4 text-center ${level === 1 ? "active-1" : "deavtive-1"}`}> تایید یا رد مدارک توسط کارشناس </span>
                </div>
                <div className='d-flex flex-column align-items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="svgOne border p-1">
                    ...
                    <span className={`mx-5 mt-3 d-flex p-2 rounded-circle btn-outline-light ${level === 2 ? "active22" : "deactive22"}`}></span>
                    <span className={`my-3 px-4 text-center ${level === 2 ? "active-1" : "deavtive-1"}`}> انتخاب استاندارد </span>
                </div>
                <div className='d-flex flex-column align-items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="svgOne border p-1">
