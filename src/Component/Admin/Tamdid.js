            ...
            <div>
                ...
                <div className='d-flex flex-column  mx-5'>
                      <div className='d-flex my-3 border-bottom pb-3'>
                          <div className='p-1 col-6 d-flex justify-content-center'>
                            <div className='col-6'>
                              ...
                              <div className=''>
                                <label className='text-white bg-primary px-2 py-1 my-4'>آپلود فایل</label>
                                <input type="file" />
                              </div>
                            </div>
                      ...
                      <div className='d-flex my-3 border-bottom pb-3'>
                          ...
                          <div className='p-1 col-6 d-flex justify-content-center'>
                              <div className='col-6'>
                                  ...
                                  <div className=''>
                                      <label className='text-white bg-primary px-2 py-1 my-2'>آپلود فایل</label>
                                      <input type="file" />
                                  </div>
                              </div>
                              <div className='col-5 mb-4 bg-secondary bg-opacity-75'>
                  ...
                  <div className='text-start mt-2 mb-4'>
                      <Link to="/TamdidTaeid">
                    <button className='btn btn-primary mx-5 px-3 rounded-0'> ثبت درخواست </button>
                    </Link>
                  </div>
