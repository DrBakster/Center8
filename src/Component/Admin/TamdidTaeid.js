    ...
    <LayoutAdmin>
      <div className=''>
        ...
        <div className='text-center my-4'>
          <button className='btn btn-primary rounded-0 px-4 mx-5'> پرداخت </button>
        </div>
        <div className='my-5'>
        ...
        <div className='mx-5 mt-3 mb-5 p-5 bg-secondary bg-opacity-50 justify-content-center align-items-center'>
          <div className='p-5 mx-auto shadow-lg w-50 border d-flex flex-column justify-content-center align-items-center'>
            <input type="file" />
            <label className='text-white my-3 bg-primary p-3'>آپلود رسید پرداخت </label>
          </div>
        ...
        <div className='text-start ps-5 mb-2'>
          <Link to="/TamdidAzmon">
            <button className='btn btn-primary rounded-0 px-5 py-2'> ثبت درخواست</button>
          </Link>
        </div>
