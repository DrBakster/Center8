                    ...
                    <tbody className='text-center'>
                        <tr className='text-black'>
                            ...
                            <tr className='d-flex p-0 border border-dark justify-content-center'>
                                ...
                                <th colSpan="" className='flex-grow-1 flex-shrink-1 col-1 border-0 px-3 bg-primary'> ISCO کد </th>
                            </tr>
                            <th>جمع ساعت </th>
                            <th>توضیحات بیشتر </th>
                            ...
                            tableData.map(item=>(
                                <tr>
                                    ...
                                    <td className='d-flex flex-row justify-content-between border-0 border-dark p-0'>
                                        ...
                                        <td className='col-1 d-flex flex-row flex-grow-1 flex-shrink-1 border-0 bg-primary'>
