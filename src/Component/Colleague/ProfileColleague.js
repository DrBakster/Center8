      ...
      <div className='container-fluid py-2 px-3 m-0 my-2 mb-4'>
            ...
            <div className='p-3 border border-2'>
              <div className=''>
                ...
                <div className='d-flex bg-warnin bg-opacity-25 align-items-center my-2 shadow shadow-sm border border-1 border-secondary ulpp'>
                  ...
                  <p className='my-0'> کارشناس فنی </p>
                </div>
        ...
        <div className='my-3'>
          <div className='border border-2 p-2'>
            <fieldset className=''>
              <legend className='bg-primary bg-opacity-50 fw-bold p-2'> زمینه های کارشناسی </legend>
              <p className='m-0 p-4 border rounded'>
                <ul>
                  <li className='my-1'> کارشناس رشته آی تی </li>
                  <li className='my-1'> کارشناس رشته ارتباطلات </li>
                </ul>
              </p>
            </fieldset>
          </div>
