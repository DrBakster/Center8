          ...
          <div className='col-6 border-2 bg-light px-1 d-flex flex-column justify-content-strat'>
            ...
            <div className=' d-flex flex-column border rounded px-2 pt-4 pb-1 position-relative'>
              <div className='my-1 mt-2 p-2 d-flex justify-content-between'>
                <div className='col-7 fw-bold'>شما هیچ پرونده جدید ندارید !</div>
              ...
              <p className='fromto m-0'> پوشه پرونده شما خالی است </p>
              <button className='d-grid col-4 me-auto btn btn-primary m-0 p-1 px-1 ms-0 my-3 position-absolute btn-absolute'>مشاهده پرونده</button>
            </div>
          </div>
          <div className='col-6 border-2 bg-light px-1 d-flex flex-column justify-content-strat'>
            ...
            <div className=' d-flex flex-column border rounded px-2 pt-4 pb-1 position-relative'>
              ...
              <button className='d-grid col-4 me-auto btn btn-primary m-0 p-1 px-1 ms-0 my-3 position-absolute btn-absolute'>مشاهده پرونده ها</button>
            </div>
          </div>
        </div>
      </div>
