...
import khabar1 from '../img/000_104332.jpg';
                ...
                <Slider className='py-3 border-top col-md-12 slider-slid' {...settings}>
                    <div className="card col-lg-1 border">
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-danger d-none d-md-none d-lg-block ">يکشنبه ٢٦ تير ١٤٠١</h5>
                    ...
                    <div className="card col-lg-1 border">
                        ...
                        <div className="card-header hhh fw-bold bg-secondary text-white">
                            پیام تبریک معاون وزیر و رئیس سازمان آموزش فنی و حرفه ای کشور
                        </div>
                        <div className="card-body">
                            <h5 className="card-title text-danger d-none d-md-none d-lg-block">سه شنبه ١ شهريور ١٤٠١</h5>
                            <p className="card-text d-none d-md-none d-lg-block ppp">امید است با داشتن روحیه انقلابی و جهادی، در راستای تحقق آرمان‌های بلند حضرت امام خمینی(ره) و مقام معظم رهبری (مدظله العالی) افق‌های تازه ای از «انقلاب مهارت آموزی» را به منصه ظهور رسانده و زمینه‌های رشد و پیشرفت روزافزون کشور در عرصه های مختلف را فراهم آورده و امید را به جامعه نوید بخشید.</p>
                            <div className='d-flex justify-content-around align-items-center '>
                    ...
                    <div className="card col-lg-1 border">
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-danger d-none d-md-none d-lg-block">دوشنبه ٣١ مرداد ١٤٠١ </h5>
                    ...
                    <div className="card col-lg-1 border">
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-danger d-none d-md-none d-lg-block">شنبه ٢٩ مرداد ١٤٠١</h5>
