...
function NavbarMenu() {
    ...
    return (
        <>
            <button className='d-flex d-md-none d-lg-none d-xl-none p-3 btn btn-light buttomMenu' onClick={() => setOpenMenu( !openMenu )}></button>
            <div className='d-flex d-none d-md-flex justify-content-evenly align-items-center pe-4 p-0 pe-md-1 haeder123'>
                <span className='me-auto ps-3 ps-lg-1 px-md-0 me-lg-0 ms-lg-3 me-md-0'>
                ...
                <div className='d-flex align-items-center me-0 me-lg-3 pe-1 pe-md-1 pe-lg-3 ms-lg-4 ps-lg-3'>
                    ...
                    <div className="ps-5 ps-md-1 pe-lg-2 pe-md-2 ps-lg-1 me-md-0 me-lg-3 d-lg-block d-md-block d-sm-none d-none">
                        ...
                        <button onClick={() => setModalState( { ...modalState, modalSignup: true } )} className="btn btn-primary rounded-3 mx-2 px-4 mx-1 px-md-3 px-lg-4 px-xl-4 py-2">ثبت نام</button>
                    </div>
                </div>
            </div>
        </>
