      ...
      <div className='container-fiuld'>
        ...
        <div className='d-flex'>
          <div className='col-9 justify-content-center pb-4'>
            <div className=''>
              <p style={{ fontSize: '18px' }} className='p-5 mb-5 fw-bold bg-light border-start'>* برگزاری شورای مهارت شهرستان شمیرانات میزبانی فرمانداری با حضور روسای مراکز</p>
              <div className='d-flex justify-content-center'>
                <img style={{ width: '450px', height: '350px' }} className='' src={khabar2} alt="خبر" />
              </div>
              <div className='my-4 py-3 px-3' style={{ textAlign: 'justify', lineHeight: '30px' }}>
                <div className='border-bottom my-3 py-3'>
                  <span className='mx-4'>تاریخ : 1401/04/26 </span>
                </div>
