  ...
  return (
    <>
      <div className='container-fluid justify-content-center text-center border my-4 py-5 px-0 px-md-1 px-lg-2 m-0'>
        ...
        <div className=' my-4 mx-auto px-5 bg-secondary bg-opacity-50 w-75 text-center rounded py-4' id="call">
          <h3 className='fw-bold'> تماس با ما</h3>
          <p className='text-dark fw-bold py-2'>
            شما میتوانید در این قسمت با ما در تماس باشید
          </p>
          <div className='input-group'>
            <input className='form-control form-control-sm mx-1 rounded' type="text" placeholder='نام و نام خانوادگی ...' />
            <input className='form-control form-control-sm mx-1 rounded' type="emil" placeholder='ایمیل : tehran@gmail.com' />
          </div>
          <div className="my-4 ">
            <label htmlFor="Textarea1" className="form-label"></label>
            <textarea className="form-control" id="Textarea1" rows="3" placeholder='پیام های خود را در اینجا بنویسید'>
            </textarea>
          </div>
          <button className='btn btn-dark px-3 py-2 px-md-5 py-md-3'> ثبت تماس </button>
        </div>
        <div className='d-flex flex-column flex-md-row justify-content-end align-items-center p-0 px-4 px-md-0'>
          <div className='col-12 text-end text-md-center text-lg-center my-1 pe-0 col-md-4'>
            <img className='img-fluid rounded-circle bg-dark p-1 p-md-2 p-lg-3 me-1' src={Call1} alt='کانال های تماس با ما' />
            <small className='me-3 px-0 px-lg-2 me-md-0 me-md-0'>
              شماره تلفن:22185381-(021)
            </small>
          </div>
          <div className='col-12 text-end text-md-center text-lg-center my-1 pe-0 col-md-4'>
            <img className='img-fluid rounded-circle bg-dark p-1 p-md-2 p-lg-3 me-1' src={Call2} alt='کانال های تماس با ما' />
            <small className='me-3 px-0 px-lg-2 me-md-0'>
              info@cente8.tehrantvto.ir
            </small>
          </div>
          <div className='col-12 text-end text-md-center text-lg-center my-1 pe-0 col-md-4'>
            <img className='img-fluid rounded-circle bg-dark p-1 p-md-2 p-lg-3 me-1' src={Call3} alt='کانال های تماس با ما' />
            <small className='me-3 px-0 px-lg-2 me-md-0 me-md-0'>
