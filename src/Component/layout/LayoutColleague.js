...
const LayoutColleague = ( { children } ) => {
  ...
  return (
      <div className='container-fluid bg-light p-0 admin-main'>
          ...
          <div className=' d-flex headerAdmin'>
              <div className='col-3 col-md-4 col-lg-3 d-flex bg-primary align-items-center p-2 border-start Right-header'>
                  ...
                  <div className='me-0 text-white'>
                      <span className='m-0 fw-bolder ms-2'> خانم مینا مهرنوش </span>
                  </div>
              </div>
              <div className='col-9 col-md-8 col-lg-9 bg-primary d-flex justify-content-between align-items-center px-1 Left-header'>
          ...
          <div className='container-fluid d-flex bg-white p-0 m-0'>
              <div className='col-3 col-md-4 col-lg-3 Right-Admin'>
                  <ul className='list-unstyled d-flex flex-column ps-2'>
                      <Link to="/Colleague" className={`d-flex align-items-center LinkAdmin text-decoration-none pe-2 ps-3 rounded-start ${location.pathname === '/Colleague' && "LinkAdminActive"}`}>
                      ...
                      <Link to="/ProfileColleague" className={`d-flex align-items-center LinkAdmin text-decoration-none pe-2 ps-3 rounded-start ${location.pathname === '/ProfileColleague' && "LinkAdminActive"}`}>
                      ...
                      <Link to="/Archive" className={`d-flex align-items-center LinkAdmin text-decoration-none pe-2 ps-3 rounded-start ${location.pathname === '/Archive' && "LinkAdminActive"}`}>
...
export default LayoutColleague